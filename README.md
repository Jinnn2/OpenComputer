...
当前已进入 Batch 3：Android Client V0 原型。Host V0 真实采集验收见 [docs/BATCH2_HOST_V0_ACCEPTANCE.md](docs/BATCH2_HOST_V0_ACCEPTANCE.md)，Android Client V0 构建验收见 [docs/BATCH3_CLIENT_V0_ACCEPTANCE.md](docs/BATCH3_CLIENT_V0_ACCEPTANCE.md)。
...
- [docs/ANDROID_CLIENT_USER_GUIDE.md](docs/ANDROID_CLIENT_USER_GUIDE.md)：Android 端操作说明
- [docs/ANDROID_CLIENT_DEBUG_GUIDE.md](docs/ANDROID_CLIENT_DEBUG_GUIDE.md)：Android 端电脑调试说明
...
如果本机没有 FFmpeg，可以先安装项目内 portable 版本：
...
```powershell
powershell -ExecutionPolicy Bypass -File host-windows\scripts\accept-v0.ps1 -CaptureSeconds 5 -TestCapture
```

构建 Android Client V0：
